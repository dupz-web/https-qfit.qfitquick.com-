export const ACHIEVEMENTS = [
 ...
 { id:'time10', icon:'', label:{ko:'누적 운동 10분', en:'10 Min Total'}, check:p => (p.totalWorkoutSeconds||0) >= 600 },
 ...
 { id:'rival1', icon:'', label:{ko:'라이벌 등장', en:'Rival Accepted'}, check:p => (p.challengesAccepted||0) >= 1 },
];
